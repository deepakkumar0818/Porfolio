  ...
  const featuredProjects = [
    {
      ...
      description: 'Scalable e-commerce solution with advanced analytics, AI-powered recommendations, and multi-vendor marketplace capabilities.',
      image: '/api/placeholder/600/400',
      technologies: ['Next.js 14', 'TypeScript', 'Stripe', 'Prisma', 'PostgreSQL'],
      liveUrl: '/projects/enterprise-ecommerce',
      githubUrl: '#',
      category: 'Full Stack',
      status: 'Live',
      metrics: { users: '10K+', revenue: '$2M+', performance: '99.9%' },
    ...
    },
    {
      ...
      liveUrl: '/projects/ai-analytics',
      githubUrl: '#',
      category: 'AI/ML',
      status: 'Beta',
      metrics: { accuracy: '94%', speed: '2x faster', insights: '500+' },
