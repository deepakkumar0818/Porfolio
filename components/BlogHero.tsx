      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          ...
          <div className="space-y-4">
            ...
            >
              Exploring web development, technology trends, and software engineering best practices
            </motion.p>
          </div>
          ...
          >
            {[
              { icon: Newspaper, number: '50+', label: 'Articles Published' },
              { icon: TrendingUp, number: '10K+', label: 'Monthly Readers' },
              { icon: BookOpen, number: '25+', label: 'Topics Covered' },
            ].map((stat, index) => (
              <motion.div
                key={stat.label}
