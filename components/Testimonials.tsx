  ...
  const testimonials = [
    {
      ...
      content: 'Working with Deepak Kumar was an absolute pleasure. They delivered a stunning web application that exceeded our expectations. The attention to detail and technical expertise is unmatched.',
      rating: 5,
    ...
    },
    {
      ...
      content: 'The AI-powered dashboard they built for us has revolutionized how we analyze our data. The performance improvements and user experience enhancements are remarkable.',
      rating: 5,
      image: '/api/placeholder/100/100',
    ...
    },
    {
      ...
      company: 'DigitalFlow',
      content: 'From concept to deployment, the entire process was smooth and professional. They understood our vision and brought it to life with cutting-edge technology.',
      rating: 5,
      image: '/api/placeholder/100/100',
